 ...
 * @author vuqua
 */
public class FormCa2 extends javax.swing.JFrame {

    /**
     * Creates new form FormCa2
     */
    ...
    try {
       ...
       // Trong một lớp khác, ví dụ WorkerForm
        WorkerDAOCa2 workerDAO = new WorkerDAOCa2();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Bạn đã checkout ca 2 hôm nay rồi!!!.");
        } else {
            java.util.Date currentDate = new java.util.Date();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCa2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
