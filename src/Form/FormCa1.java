 ...
 * @author vuqua
 */
public class FormCa1 extends javax.swing.JFrame {

    /**
     * Creates new form FormChamCongWorker
     */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Bạn đã checkout ca 1 hôm nay rồi!!!.");
        } else {
            java.util.Date currentDate = new java.util.Date();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCa1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
