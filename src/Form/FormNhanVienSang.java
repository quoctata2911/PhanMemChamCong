 ...
 * @author vuqua
 */
public class FormNhanVienSang extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       NhanVienDAO nhanVienDAO = new NhanVienDAO();
        ...
        Time gioBatDau = nhanVienDAO.getGioLamViecById(1).getThoiGianBatDau();
        Time gioKetThuc = nhanVienDAO.getGioLamViecById(1).getThoiGianKetThuc();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Time gioKetThuc = nhanVienDAO.getGioLamViecById(1).getThoiGianKetThuc();
        Time gioBD = nhanVienDAO.getGioLamViecById(1).getThoiGianBatDau();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormNhanVienSang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormNhanVienSang().setVisible(true);
            }
        });
    }
